    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "המסורית - יוצרים בשיח משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'cb4ebf1e-a6a2-4858-b980-a8576012f030',
                    name: data.name || '',
                    email: data.email || '',
